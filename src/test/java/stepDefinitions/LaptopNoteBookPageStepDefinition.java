...
import pageObjects.LaptopNoteBookPageObject;
import utilities.WebDriverUtility;

public class LaptopNoteBookPageStepDefinition extends Base {
	
	LaptopNoteBookPageObject laptopPageObj = new LaptopNoteBookPageObject();
