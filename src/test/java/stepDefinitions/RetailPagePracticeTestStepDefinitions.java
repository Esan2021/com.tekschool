...
import pageObjects.RetailPageObjPractice;
import utilities.WebDriverUtility;

public class RetailPagePracticeTestStepDefinitions extends Base {

	// In this class we will write Actual Java/Selenium codes associated to each
	// Sceanrio
	// Steps.

	RetailPageObjPractice retailPage = new RetailPageObjPractice();
